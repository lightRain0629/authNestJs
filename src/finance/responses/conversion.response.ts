  ...
  constructor(conversion: CurrencyConversion) {
    ...
    this.feeAmount =
      conversion.feeAmount instanceof Prisma.Decimal
        ...
        : conversion.feeAmount
          ? String(conversion.feeAmount)
          : null;
